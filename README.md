...
## Harness plugin — planning/review release (0.1.3)
...
node scripts/build-harness.mjs --export dist/harness-0.1.3   # bundle; harness-release.json says whether live evidence for these bytes ships
