...
## Harness plugin — planning/review release (0.1.2)
...
node scripts/build-harness.mjs --export dist/harness-0.1.2   # bundle; harness-release.json says whether live evidence for these bytes ships

# install from the exported bundle (operator actions)
claude plugin marketplace add dist/harness-0.1.2 --scope project && claude plugin install harness@ai-coding-starter --scope project
codex  plugin marketplace add dist/harness-0.1.2 && codex plugin add harness@ai-coding-starter --json
```
