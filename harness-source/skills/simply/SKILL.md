---
name: simply
description: Re-explain what just happened in plain language — short, concrete and decision-ready, for a reader who did not follow the technical detail.
argument-hint: "[optional: what to re-explain | empty → the last thing we did]"
wrapper-description: Re-explain what just happened in plain language
---

# simply — say it again, simply

**Input:** optional pointer at what to re-explain. Empty → the work just completed in this session.
...
**If no focus was given**, the subject is the immediately preceding work in this
