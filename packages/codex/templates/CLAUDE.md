...
> **Source of truth for quality gates.** `/harness:gates-verify-implementation` and `/orchestrate` read this section and run these commands in sequence (fail fast). Kept in sync with `.agents/project-rules.md → Validation` by the renderer.
